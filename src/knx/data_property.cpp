...
const uint8_t* DataProperty::restore(const uint8_t* buffer)
{
    ...
    //Serial.print("Restored Elements: ");
    ...
    if (elements != _currentElements)
    {
        ...
        //Serial.print("Allocated Data Array with Size: ");
        //Serial.println(elements * ElementSize());
    }
...
uint8_t* DataProperty::save(uint8_t* buffer)
{
    ...
    //Serial.print("Saved Elements: ");
    Serial.println(_currentElements);
