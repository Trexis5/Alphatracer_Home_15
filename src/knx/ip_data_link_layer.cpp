...

{
    ...
    //Serial.println(frame.toString().c_str());
...
void IpDataLinkLayer::loop()
{
    ...
    switch ((KnxIpServiceType)code)
    {
        case RoutingIndication:
        {
              ...
              /*
            print("RoutingIndication");print("   len: ");;println(len);
             
            Serial.print("Pufferinhalt: ");
            for (int i = 0; i < len; ++i) {
                if (buffer[i] < 0x10) {
                    Serial.print("0");
                }
        ...
        {
              /*
            print("SearchRequest");print("   len: ");;println(len);
            ...
            println(hpai.ipAddress());
            println(hpai.ipPortNumber());
            //println(searchResponse.data());
            println(searchResponse.totalLength());
             */
